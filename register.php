...
<body>
    ...
    <script>
        // Fitur Interaktif: Show / Hide Password Toggle untuk Kata Sandi
        ...
        // Fitur Interaktif: Show / Hide Password Toggle untuk Konfirmasi Kata Sandi
        const toggleConfirmPasswordButton = document.querySelector('#toggleConfirmPassword');
        const confirmPasswordInputField = document.querySelector('#confirmPassword');

        toggleConfirmPasswordButton.addEventListener('click', function () {
            const currentInputType = confirmPasswordInputField.getAttribute('type') === 'password' ? 'text' : 'password';
            confirmPasswordInputField.setAttribute('type', currentInputType);
            this.classList.toggle('fa-eye');
            this.classList.toggle('fa-eye-slash');
        });
    </script>
