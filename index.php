...
<head>
    ...
    <style>
        ...
        .hero-section {
            ...
            display: flex;
            align-items: center;
            background-image: url('https://images.unsplash.com/photo-1603833665858-e61d17a86224?q=80&w=2000&auto=format&fit=crop');
        ...
        .hero-overlay {
            ...
            background: linear-gradient(90deg, rgba(250,250,250,1) 0%, rgba(250,250,250,0.9) 45%, rgba(250,250,250,0) 100%);
            z-index: 1;
        }
        .hero-content {
            position: relative;
        ...
        .btn-primary-custom:hover {
            ...
            box-shadow: 0 8px 25px rgba(138, 111, 0, 0.3);
        }
        .btn-outline-custom {
        ...
        .icon-box.yellow { background-color: rgba(255, 214, 0, 0.15); color: var(--secondary); }
        .icon-box.green { background-color: rgba(40, 167, 69, 0.1); color: #28a745; }
        .icon-box.blue { background-color: rgba(23, 162, 184, 0.1); color: #17a2b8; }
        ...
        .newsletter-btn:hover { background-color: var(--text-dark); }
...
<body>
    ...
    <section class="py-5 mt-5">
        <div class="container">
            <div class="text-center mb-5" data-aos="fade-up">
                <h2 class="fw-bold">Kenapa Kami?</h2>
                <p class="text-muted">Kami berkomitmen memberikan kualitas terbaik, dari kebun hingga ke meja Anda.</p>
            </div>
    ...
    <section class="py-5">
        <div class="container">
            <div class="text-center mb-5" data-aos="fade-up">
                <h2 class="fw-bold">Kata Mereka</h2>
            </div>
    ...
    <section class="newsletter-section text-center" data-aos="zoom-in">
        <div class="container">
            <h2 class="fw-bold mb-3">Dapatkan Promo Menarik!</h2>
            <p class="mb-4">Daftar buletin kami untuk info produk terbaru dan diskon khusus.</p>
